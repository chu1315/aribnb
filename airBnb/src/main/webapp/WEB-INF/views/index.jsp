            ...
            <div class="joinCore" id="showJoin">
               ...
               <div class="joinFooter">
				...
				<div class="joinCore" id="joinSubmit">
					<form id="joinForm" name="joinSubmit" action="/join" method="post" onsubmit="return chk()">
					<div class="joinCtnt">
							<div class="joinBox">
								...
								<div>
									...
									<div>
										<input type="text" name="nm" placeholder="이름 (예: 홍길동)">
									</div>
									<div>
										<input type="password" name="c_pw" placeholder="비밀번호 설정하기">
									</div>
								</div>
							...
							<input type="submit" class="mailJoin" value="가입하기">
						</div>
					</div>
					</form>
				</div>
